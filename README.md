...
useRouteMatch allows you to easily build more flexible code, making it so you don't have to go through and change every level of the route, instead only working on the top level, the routeMatch will fix the sub-routes.
1. How would you explain form validation to someone who has never programmed before?
Validation is a way to control what a user can input/not input into a form or database, allowing you to build your code around specific inputs while avoiding bugs that something outside of your scope would cause.
1. In 1-2 sentences, define end to end testing.
End to end testing is a testing flow that tests an application from the beginning to the end, it aims to in a way replicate what it's like to have a user on your application.
